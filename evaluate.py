...
testcur.execute("create table teacher(Username text,Password text,TypeUser text,Name text,Surname text,Subject text,Tel text,Email text)")
#testcur.execute("create table admin_pdf_TA(ID text, property text,course_syllabus text, Result text)")
#testcur.execute("create table admin_pdf_Hiring(ID text, property text, course_syllabus text, Result text)")
